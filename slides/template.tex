...
\title[]{DALLE-2: "Picture Perfect or Ethically Problematic?"}% The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Example: Dall-E 2 by OpenAI; MidjourneyAI by MidjourneyAi
	\end{itemize}
\end{frame}
		...
		\begin{columns}[c] 
			\begin{column}{0.6\textwidth} % Left column width
				\begin{itemize}
					...
					%\item How much of this can even be regulated?
				\end{itemize}
			\end{column}
