...
\begin{frame}
	...
	\begin{itemize}
		...
		\item No drawing or computer skills required
	\end{itemize}
\end{frame}
...
% 	-> Is this below the "needs regulation" bar? overregulation?
	\frametitle{Portrayal of socially unacceptable or mildly illegal actions}
		\begin{columns}[c] 
			\begin{column}{0.5\textwidth} % Left column width
				\begin{itemize}
					\item examples: children smoking, bullying, ...
					\item 
				\end{itemize}
			\end{column}
			\begin{column}{0.5\textwidth} % Right column width
				\begin{figure}
					...
					\caption{\tiny A child smoking a cigarette }
				\end{figure}
			\end{column}
		\end{columns}
\end{frame}
...
\begin{frame}
% - Portrayal of Racism / Misogyny / Hateful Content / Extreme Violence
	\frametitle{Portrayal of Racism / Misogyny / Hateful Content / Extreme Violence}
	\begin{itemize}
		\item 
	\end{itemize}
\end{frame}
...
% 	-> Child pronography, revenge porn
	...
	\begin{itemize}
		...
		\item Unstable Diffusion: Model targeted specifically at porn generation
		\item \textbf{Big risk}, but also a chance for a controversial industry?
	\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{Visualization: some guidelines are strict, some are not}
	\begin{columns}[c] 
		\begin{column}{0.5\textwidth} % Left column width
			\begin{figure}
				\includegraphics[width=0.7\linewidth]{Images/CommunityGuidelinesDALLE2.png}
				\caption{\tiny Excerpt from the Community Guidelines of OpenAI's DallE-2}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth} % Right column width
			\begin{figure}
				\includegraphics[width=0.7\linewidth]{Images/CommunityGuidelinesMidjourneyAI.png}
				\caption{\tiny Excerpt from the Community Guidelines of MidJourney Inc's MidjourneyAI } 
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
...
% 	-> who is liable? programmer / business / user
	...
	\begin{figure}
		...
		\caption{\tiny Manipulating an immoral image by localizing immoral visual attributes and manipulating them into a morally-satisfying alternative. } 
	\end{figure}
