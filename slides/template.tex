...
\begin{frame}
	\frametitle{Some are very specific, some are not}
	\begin{columns}[c] 
		\begin{column}{0.5\textwidth} % Left column width
			\begin{figure}
				\includegraphics[width=0.7\linewidth]{Images/CommunityGuidelinesDALLE2.png}
				\caption{\tiny relevant excerpt }
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth} % Right column width
			\begin{figure}
...
% 	-> who is liable? programmer / business / user
	...
	\begin{itemize}
		\item add watermark / clear labeling of AI-generated images
		\item add content filter ("select keywords, seperate model to detect immorality")
