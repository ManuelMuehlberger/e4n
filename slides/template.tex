...
% 	-> Is this below the "needs regulation" bar? overregulation?
	\frametitle{Portrayal of socially unacceptable or illegal actions}

		\begin{columns}[c] 
			\begin{column}{0.5\textwidth} % Left column width
				\begin{itemize}
					\item children smoking, bullying, ...
				\end{itemize}
			\end{column}
			\begin{column}{0.5\textwidth} % Right column width
				\begin{figure}
					...
					\caption{\tiny A child smoking a cigarette, taken from }
				\end{figure}
			\end{column}
		\end{columns}
\end{frame}
...
%	-> cheating in games <--> cheating in art-contests
	...
	\begin{figure}
		\includegraphics[width=0.7\linewidth]{Images/ColoradoStateFairWinner.png}
...
% 	-> Child pronography, revenge porn
	...
	\begin{itemize}
		...
		\item Models specifically targeted towards pornographic image generation
	\end{itemize}
\end{frame}
